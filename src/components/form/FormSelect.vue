    ...
    <div>
      <div class="select-wrapper relative">
        <select :value="modelValue"
          class="appearance-none border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 block w-full pl-3 pr-6 py-2"
          :class="`${modelValue === '' ? 'text-gray-300' : 'text-slate-700'} ${disabled ? 'bg-slate-100' : 'bg-white'
            } ${error &&
